...
def upgrade() -> None:
    ...
    op.create_table(
        'aliquotas',
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('tipo_tributo', sa.Enum('IPTU', 'ITBI', 'ISSQN', 'TAXA', 'CONTRIBUICAO', name='tipo_tributo'), nullable=False),
        sa.Column('tipo_uso', sa.Enum('RESIDENCIAL', 'COMERCIAL', 'INDUSTRIAL', 'MISTO', 'RURAL', 'PUBLICO', name='tipo_uso'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('LANCADO', 'PAGO', 'PAGO_PARCIAL', 'CANCELADO', 'PARCELADO', 'EM_DIVIDA', name='status_lancamento'), default='LANCADO'),
    ...
    op.create_table(
        ...
        sa.Column('tipo_tributo', sa.Enum('IPTU', 'ITBI', 'ISSQN', 'TAXA', 'CONTRIBUICAO', name='tipo_tributo'), nullable=False),
        sa.Column('tipo_isencao', sa.Enum('TOTAL', 'PARCIAL', name='tipo_isencao'), nullable=False),
