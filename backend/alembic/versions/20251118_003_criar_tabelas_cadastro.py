...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('tipo_pessoa', postgresql.ENUM('F', 'J', name='tipo_pessoa', create_type=False), nullable=False),
        sa.Column('situacao_cadastral', postgresql.ENUM('ATIVO', 'INATIVO', 'SUSPENSO', 'CANCELADO', name='situacao_cadastral', create_type=False), default='ATIVO'),
        # PF
    ...
    op.create_table(
        'logradouros',
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('tipo_logradouro', postgresql.ENUM('RUA', 'AVENIDA', 'TRAVESSA', 'PRAÇA', 'ALAMEDA', 'RODOVIA', 'ESTRADA', 'OUTRO', name='tipo_logradouro', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('tipo_imovel', postgresql.ENUM('TERRENO', 'EDIFICADO', 'TERRITORIAL', name='tipo_imovel', create_type=False), nullable=False),
